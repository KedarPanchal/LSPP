...
public class Args {
    ...
    @Parameter(names={"-d", "--depth"}, description="The number of layers of files that will be listed. If left blank or given a value of 0, all subfiles and subdirectories will be listed.")
    ...
    @Parameter(names={"-c", "--charset"}, description="""
            ...
            1. box
            2. ascii""", converter=CharsetConverter.class)
